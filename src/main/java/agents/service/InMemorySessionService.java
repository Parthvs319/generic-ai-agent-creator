...
public final class InMemorySessionService implements BaseSessionService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.google.adk.sessions.InMemorySessionService.class);
    ...
    public void addSession(Session session , String sessionId , String userId , String appName) {
        sessions
                .computeIfAbsent(appName, k -> new ConcurrentHashMap<>())
                .computeIfAbsent(userId, k -> new ConcurrentHashMap<>())
                .put(sessionId, session);
